...
// Fetch initiatives with initiative_type 'sustainnable fishing'
$stmt = $conn->prepare("SELECT * FROM initiatives WHERE initiative_type = ?");
$type = 'sustainable fishing';
...
<head>
  <meta charset="UTF-8">
  <title>Sustainable Fishing Initiatives</title>
...
<div class="container main-container">
  <h2 class="mb-4 text-center">Sustainable Fishing Initiatives</h2>
  <p class="intro">Sustainable Fishing initiatives aim to ensure that fish populations remain healthy while minimizing environmental damage. These efforts focus on using eco-friendly fishing gear, reducing bycatch, and promoting certification programs that recognize responsible fishing practices. The goal is to support both marine ecosystems and the livelihoods of fishing communities.</p>
  <p style="font-size: 16px; line-height: 1.6; margin: 10px 0; color: #003366;">
  <strong>What it does:</strong> Sustainable Fishing helps regulate how marine species are harvested to ensure that ocean ecosystems remain balanced and productive. It involves setting catch limits, avoiding overfishing, protecting endangered species, and using eco-friendly gear that minimizes harm to other marine life. The goal is to allow fish populations to replenish naturally while still supporting the needs of coastal communities and the fishing industry.
</p>
  ...
  <?php if (!empty($initiatives)): ?>
    ...
    <?php endforeach; ?>
  <?php else: ?>
    <p class="text-center">No initiatives found for Sustainable Fishing.</p>
  <?php endif; ?>
</div>
