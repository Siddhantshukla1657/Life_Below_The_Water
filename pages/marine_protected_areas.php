...
// Fetch initiatives with initiative_type 'marine_protected_areas'
$stmt = $conn->prepare("SELECT * FROM initiatives WHERE initiative_type = ?");
$type = 'marine_protected_areas';
...
<head>
  <meta charset="UTF-8">
  <title>Marine Protected Areas Initiatives</title>
...
<div class="container main-container">
  <h2 class="mb-4 text-center">Marine Protected Areas Initiatives</h2>
  <p class="intro">Marine Protected Areas are designated zones in our oceans where human activity is regulated to preserve biodiversity and protect vital ecosystems. These initiatives create safe havens for marine life, support sustainable fishing practices, and help in the recovery of endangered species by maintaining critical habitats such as coral reefs and seagrass beds.</p>
  <p style="font-size: 16px; line-height: 1.6; margin: 10px 0; color: #003366;">
  <strong>What it does:</strong> Marine Protected Areas (MPAs) are specific parts of the ocean set aside to conserve biodiversity, habitats, and cultural resources. Activities like fishing, drilling, and development are restricted or managed within these zones to reduce human impact. MPAs help ecosystems recover, boost fish populations, and preserve vital breeding grounds for marine species, ensuring long-term sustainability of the oceans.
</p>
  ...
  <?php if (!empty($initiatives)): ?>
    ...
    <?php endforeach; ?>
  <?php else: ?>
    <p class="text-center">No initiatives found for Marine Protected Areas.</p>
  <?php endif; ?>
</div>
